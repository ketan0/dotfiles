...
[:f [:yabai "window --grid 16:10:3:2:4:12"]]
...
;; [:p "bash ~/.dotfiles/get_window_title.sh"]
#+end_src
...
[:d [:smarturl "https://www.doordash.com/"]]
...
[:i "open /System/Applications/Stickies.app && bash ~/.dotfiles/focus_window_with_title.sh intentions"]
[:n "open /System/Applications/Stickies.app && bash ~/.dotfiles/focus_window_with_title.sh scratchpad"]
[:j [:smarturl "http://localhost:8888"]] ;; the port I usually run JupyterLab on
[:k [:open "/Users/ketanagrawal/.dotfiles/karabiner.org"]]
[:l [:smarturl "https://chat.openai.com"]]
